...
```bash
kubectl apply -f https://raw.githubusercontent.com/go-faster/tetragon/main/crds/examples/sys_write_follow_fd_prefix.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/go-faster/tetragon/main/crds/examples/sys_write_follow_fd_prefix.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/go-faster/tetragon/main/crds/examples/tcp-connect.yaml
```
...
To disable the TracingPolicy run:
```bash
kubectl delete -f https://raw.githubusercontent.com/go-faster/tetragon/main/crds/examples/tcp-connect.yaml
```

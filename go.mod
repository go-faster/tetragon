...
require (
	...
	github.com/go-faster/tetragon/api v0.8.5
	github.com/go-faster/tetragon/pkg/k8s v0.8.5
...
replace (
	...
	github.com/cilium/tetragon/api v0.8.5 => ./api
	github.com/cilium/tetragon/pkg/k8s v0.8.5 => ./pkg/k8s

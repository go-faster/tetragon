...
| export.stdout.image.repository | string | `"ghcr.io/cilium/hubble-export-stdout"` |  |
...
| tetragon.image.repository | string | `"ghcr.io/go-faster/tetragon"` |  |
| tetragon.image.tag | string | `"v0.8.10"` |  |
...
| tetragonOperator.image | object | `{"override":null,"repository":"ghcr.io/go-faster/tetragon-operator","suffix":"","tag":"v0.8.10"}` | tetragon-operator image. |

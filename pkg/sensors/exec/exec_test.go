...
import (
	...
	proc "github.com/go-faster/tetragon/pkg/process"
...
func TestDocker(t *testing.T) {
	...
	readyWG.Wait()
	serverDockerID := observer.DockerRun(t, "--name", "fgs-test-server", "--entrypoint", "nc", "ghcr.io/cilium/alpine-curl:1.0", "-nvlp", "8081", "-s", "0.0.0.0")

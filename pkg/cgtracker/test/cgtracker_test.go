...
import (
	...
	grpcexec "github.com/go-faster/tetragon/pkg/grpc/exec"
	...
	_ "github.com/go-faster/tetragon/pkg/sensors/exec" // NB: needed so that the exec sensor can load the execve probe on its init
	testsensor "github.com/go-faster/tetragon/pkg/sensors/test"
	_ "github.com/go-faster/tetragon/pkg/sensors/tracing" // NB: needed so that the exec tracing sensor can load its policy handlers on init
	...
	testprogs "github.com/go-faster/tetragon/pkg/testutils/progs"
